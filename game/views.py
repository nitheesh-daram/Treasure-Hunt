       ...
       if user_points==0:
              ...
              if not request.POST.get('location') is None:
                     if request.POST.get('location')=="Albert Hall":
                            ...
                            return redirect("game")
              return render(request,"game/level2.html",{})
       elif user_points==30:
              if request.POST:
              ...
              return render(request,"game/level3.html",{})
       elif user_points==65:
              if request.POST:
                     if request.POST.get('location')=="Jantar Mantar":
                            ...
                            messages.info(request,"Location Incorrect")
              return render(request,"game/level4.html",{})
              ...
              if request.POST:
                     if request.POST.get('location')=="Govind Dev Ji":
                            ...
                            messages.info(request,"Location Incorrect")
              return render(request,"game/level5.html",{})
              ...
              if request.POST:
                     if request.POST.get('location')=="Jal Mahal":
                            ...
                            messages.info(request,"Location Incorrect")
              return render(request,"game/level6.html",{})
              ...
              if request.POST:
                     if request.POST.get('location')=="Amer Fort":
                            ...
                            messages.info(request,"Location Incorrect")
              return render(request,"game/level7.html",{})
              ...
              if request.POST:
                     if request.POST.get('location')=="Nahargarh Museum":
                            ...
                            messages.info(request,"Location Incorrect")
              return render(request,"game/level8.html",{})
              ...
              if request.POST:
                     if request.POST.get('location')=="Kanak Vrindavan":
                            ...
                            messages.info(request,"Location Incorrect")
              return render(request,"game/level9.html",{})
              ...
              if request.POST:
                     if request.POST.get('location')=="Moti Doongri":
                            ...
                            messages.info(request,"Location Incorrect")
              return render(request,"game/level10.html",{})
              ...
              if request.POST:
                     ...
                     if request.POST.get('location')=="Jawahar Kala Kendra":
                            ...
                            messages.info(request,"Location Incorrect")
              return render(request,"game/level11.html",{})
       else:
              return render(request,"game/level12.html",{})